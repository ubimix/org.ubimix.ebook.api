...
public class JsonBookManifest extends JsonBookBase implements IBookManifest {
    ...
    /**
     * @see org.webreformatter.ebook.bom.IBookManifest#getItemByHref(Uri)
     */
    ...
    /**
     * @see org.webreformatter.ebook.bom.IBookManifest#getItemById(BookId)
     */
    ...
    /**
     * @see org.webreformatter.ebook.bom.IBookManifest#getItems()
     */
